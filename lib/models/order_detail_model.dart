 ...
 // int showCancelOrder;
  ...
  OrderDetailModel.fromJson(Map<String, dynamic> json) {
    try {
      ...
      showFoodReady = json['show_food_ready'];
  ...
  Map<String, dynamic> toJson() {
   ...
   // data['show_review'] = this.showReview;
    ...
    data['show_food_ready'] = this.showFoodReady;
...
class DriverData {
  ...
  DriverData({this.name, this.phone, this.locationLat, this.locationLng});
...
class OrderDetailModel {
  ...
  OrderDetailModel.fromJson(Map<String, dynamic> json) {
   ...
   if (json['driver_data'] != null) {
     driverData = new List<Null>();
     json['driver_data'].forEach((v) {
       driverData.add(new Null.fromJson(v));
     });
   }
  }
